...
public class RecentUtil {
    ...
    private RecentUtil(SharedPreferences preferences) {
        this.preferences = preferences;
    }

    public synchronized static RecentUtil getInstance(SharedPreferences preferences) {
        if (INSTANCE == null) {
            INSTANCE = new RecentUtil(preferences);
        }
